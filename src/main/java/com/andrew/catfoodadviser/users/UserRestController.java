...
import com.andrew.catfoodadviser.errors.NotFoundException;
import com.andrew.catfoodadviser.errors.UnauthorizedException;
import com.andrew.catfoodadviser.security.Jwt;
import com.andrew.catfoodadviser.security.JwtAuthentication;
import com.andrew.catfoodadviser.security.JwtAuthenticationToken;
import com.andrew.catfoodadviser.utils.ApiUtils;
...
import static com.andrew.catfoodadviser.utils.ApiUtils.success;
    ...
    public ApiUtils.ApiResult<LoginResult> login(
        ...
        try {
            ...
            final String token = user.newJwt(jwt, authentication.getAuthorities().stream()
                    ...
                    .toArray(String[]::new));
            return success(new LoginResult(token, new UserDto(user)));
